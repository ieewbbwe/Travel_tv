...
public class ProjectListAdapter extends BasicAdapter<ItemInfoBean, ProjectListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mInflater.inflate(R.layout.layout_project_list, null));
    }
