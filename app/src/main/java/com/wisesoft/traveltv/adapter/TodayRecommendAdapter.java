...
public class TodayRecommendAdapter extends BasicAdapter<ItemInfoBean, TodayRecommendAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mInflater.inflate(R.layout.layout_today_recommend, null));
    }
