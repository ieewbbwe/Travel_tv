...
/**
 * Created by picher on 2018/04/20.
 * Describe：
 */

public class ListNewDesignAdapter extends BasicAdapter<ItemInfoBean, RecyclerView.ViewHolder> {

    private static final int TYPE_HEAD = 0x01;

    public ListNewDesignAdapter(Context context) {
        super(context);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mInflater.inflate(R.layout.list_new_design_item, null));
