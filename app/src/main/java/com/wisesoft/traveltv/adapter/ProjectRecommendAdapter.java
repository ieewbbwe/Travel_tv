...
public class ProjectRecommendAdapter extends BasicAdapter<ItemInfoBean, ProjectRecommendAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mInflater.inflate(R.layout.layout_project_recommend, null));
    }
