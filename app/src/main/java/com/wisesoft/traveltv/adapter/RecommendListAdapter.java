...
public class RecommendListAdapter extends BasicAdapter<ItemInfoBean, RecommendListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mInflater.inflate(R.layout.layout_recommend_list, null));
    }
