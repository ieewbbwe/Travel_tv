...
public class SkbContainer extends RelativeLayout implements SoftKeyBoardable {
	...
	private boolean setKeyCodeEnter(SoftKey softKey) {
		if (softKey == null) {
			Lg.d(TAG,"setKeyCodeEnter softKey is null");
			return false;
		}
	...
	public boolean onSoftKeyDown(int keyCode, KeyEvent event) {
		...
		Lg.d(TAG,"onSoftKeyDown keyCode:" + keyCode);
		switch (keyCode) {
		...
		case KeyEvent.KEYCODE_DPAD_CENTER:
			...
			Lg.d(TAG,"onSoftKeyDown softKey:" + softKey);
		...
		default:
			Lg.d(TAG,"onSoftKeyDown false keyCode:" + keyCode);
			return false;
		}
		Lg.d(TAG,"onSoftKeyDown true keyCode:" + keyCode);
		return true;
	}
	...
	public boolean onSoftKeyUp(int keyCode, KeyEvent event) {
		...
		Lg.d(TAG,"onSoftKeyUp keyCode:" + keyCode);
		if (mSoftKeyboardView != null)
			mSoftKeyboardView.setSoftKeyPress(false);
		switch (keyCode) {
		case KeyEvent.KEYCODE_ENTER:
		...
		case KeyEvent.KEYCODE_DPAD_DOWN: // 下
		case KeyEvent.KEYCODE_BACK:
			Lg.d(TAG,"onSoftKeyUp true keyCode:" + keyCode);
			return true;
		}
		Lg.d(TAG,"onSoftKeyUp false keyCode:" + keyCode);
		return false;
	}
