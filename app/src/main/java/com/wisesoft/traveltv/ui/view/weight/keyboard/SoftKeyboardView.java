...
public class SoftKeyboardView extends View {
    ...
    protected void onDraw(Canvas rootCanvas) {
        ...
        if (mCacheBitmap == null) {
            Lg.d(TAG,"onDraw mCacheBitmap:" + mCacheBitmap);
    ...
    public void setSoftKeyPress(boolean isPress) {
        if (mSoftKeyboard == null) {
            Lg.e(TAG,"setSoftKeyPress isPress:" + isPress);
            return;
        }
    ...
    public boolean moveToNextKey(int direction) {
        if (mSoftKeyboard == null) {
            Lg.e(TAG,"moveToNextKey mSoftKeyboard is null");
            return false;
        }
        ...
        if (keyRow == null) {
            Lg.e(TAG,"moveToNextKey keyRow is null");
            return false;
        }

        List<SoftKey> softKeys = keyRow.getSoftKeys();
        if (softKeys == null) {
            Lg.e(TAG,"moveToNextKey keyRow -> softKeys is null");
            return false;
        }
