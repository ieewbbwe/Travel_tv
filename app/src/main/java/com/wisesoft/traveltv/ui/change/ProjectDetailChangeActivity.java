...
public class ProjectDetailChangeActivity extends NActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project_detail_change);
    }
    ...
    protected void initListener() {
       ...
       /* mAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(mContext, ProjectDetailChangeActivity.class);
        ...
        switch (v.getId()) {
            case R.id.m_play_tvc:
                ...
                if (!TextUtils.isEmpty(mItemInfoBean.getVideo_path())) {
                    ...
                    intent.putExtra(Constans.ITEM_RECOMMEND_IMG,getRecommendImages());
                }
