 ...
 */
public abstract class CommonRecyclerViewNormalAdapter<T> extends RecyclerView.Adapter<CommonRecyclerViewHolder>{
    protected Context mContext;
    private LayoutInflater mInflater;
    private List<T> mDatas = new ArrayList<>();

    public CommonRecyclerViewNormalAdapter(Context context){
        mContext = context;
        mInflater = LayoutInflater.from(context);
    }

    public CommonRecyclerViewNormalAdapter(Context context, List<T> datas){
        this(context);
        setDatas(datas);
    }
